...
function validateQ1(){
    ...
    var answer1 = document.getElementById('1C');
    ...
    if(answer1.checked == true){
        result = "AMAZING JOB! Please check out the other topics!";
    }
    else{
        result = "Sorry! This answer is wrong! The right answer was C-The Fellowship of the Ring. Please check out the other topics!";
    }
